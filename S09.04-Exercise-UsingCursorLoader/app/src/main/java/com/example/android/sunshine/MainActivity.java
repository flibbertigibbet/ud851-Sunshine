...
public class MainActivity extends AppCompatActivity implements
    ...
    public static final int IDX_WEATHER_DATE = 0;
    public static final int IDX_WEATHER_MAX_TEMP = 1;
    public static final int IDX_WEATHER_MIN_TEMP = 2;
    public static final int IDX_WEATHER_CONDITION_ID = 3;
    ...
    public Loader<Cursor> onCreateLoader(int id, final Bundle loaderArgs) {
        switch (id) {
            ...
            default:
                throw new IllegalArgumentException("Unrecognized loader: " + String.valueOf(id));
        }
    }
