...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final String LOCATION_KEY = "sunshine_location";
    private static final int WEATHER_LOADER_KEY = 42;

    private String[] mWeatherDataCache;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_LOADER_KEY, null, this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mWeatherDataCache = null;
            getSupportLoaderManager().restartLoader(WEATHER_LOADER_KEY, null, this);
            return true;
        }
